...
const DEPARTMENTS = [
  { id: "civil", name: "Civil Engineering", icon: <BuildingIcon/>, bg: "/civil.jpg" },
  { id: "me", name: "Mechanical Engineering", icon: <GearIcon/>, bg: "/mechanical.jpg" },
  { id: "ee", name: "Electrical Engineering", icon: <CircuitIcon/>, bg: "/electrical.jpg" },
  { id: "ece", name: "Electronics Engineering", icon: <CircuitIcon/>, bg: "/electronics.jpg" },
  { id: "cse", name: "Computer Science & Engineering", icon: <CodeIcon/>, bg: "/cse.jpg" },
  { id: "it", name: "Information Technology", icon: <CodeIcon/>, bg: "/it.jpg" },
  { id: "ai", name: "Centre for Artificial Intelligence", icon: <CodeIcon/>, bg: "/ai.jpg" },
  { id: "iot", name: "Centre for Internet of Things", icon: <CodeIcon/>, bg: "/iot.jpg" },
  { id: "emc", name: "Engineering Mathematics & Computing", icon: <CodeIcon/>, bg: "/math.jpg" },
  { id: "ccst", name: "Centre for Computer Science and Technology", icon: <CodeIcon/>, bg: "/cst.jpg" },
  { id: "che", name: "Chemical Engineering", icon: <BuildingIcon/>, bg: "/chemical.jpg" },
];
...
export default function ReportsPage({ navigate, onOpenDepartment }) {
  ...
  const openDept = (dept) => {
    ...
    navigate("ReportStructure");  // ✅ changed line
  };
