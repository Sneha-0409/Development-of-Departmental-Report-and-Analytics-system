    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (email.endsWith("@mitsgwl.ac.in")) {
                ...
                setMessage("Login successful with Institute Email!");
                setTimeout(() => {
                    onLoginSuccess({
            ...
            } else if (email.endsWith("@mitsgwalior.in")) {
                // Allow choosing role
                setGoogleUser(user);
                ...
                // Not allowed domain
                await signOut(auth);
                setMessage("Access Denied: Please use your official @mitsgwl.ac.in or @mitsgwalior.in email.");
            }
        } catch (error) {
                ...
                <div className="login-card">
                    ...
                    <form className="login-form" onSubmit={handleLogin}>
                        ...
                        <button 
                            ...
                            disabled={isLoading}
                        >
                            <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/wait.gif" alt="" style={{ display: isLoading ? 'none' : 'none' }} />
